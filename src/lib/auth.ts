...
const TRIP_COLUMNS =
  "id, slug, name, status, destination, vote_deadline, created_by, owner_id, meta, start_date, end_date, target_crew_size, hero_title, hero_subtitle, city_label, dates_label, target_budget_pp, created_at";
