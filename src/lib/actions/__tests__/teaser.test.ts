...
// These tests exercise the validation gates before any Supabase or Gemini
// call. The action's server dependencies (createServiceClient, cookies(),
// generateJson) are imported lazily by the call sites, so the early-return
// branches never reach them. End-to-end coverage of the cache + insert + AI
// path lives in the Playwright e2e (Task 1.14).
